...
// backend/src/services/authService.js - Update verifyEmail method
...
// Updated setupAccountPassword method with your specific requirements
async setupAccountPassword(userId, newPassword, employeeName) {
  ...
  if (!existingEmployee) {
    ...
    const newEmployee = await Employee.create({
      ...
      name: employeeName, // Use the name provided during setup
      ...
      accountId: user.id, // Link to User record
      identifier: user.email,
      type: 'personal',
      organizationId: user.organizationId,
      projects: [],
...
// Add the generateEmployeeId method to AuthService
generateEmployeeId() {
  const crypto = require('crypto');
